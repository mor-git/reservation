            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              @foreach($compteurs as $compteur)
                <tr>
                  ...
                  <td>
                     <a href="{{ url('/editCompteur', $compteur->id )}}"><i class='far fa-edit' style='font-size:20px;'></i></a>
                     &nbsp;
                     <a href="{{ url('/editCompteur', $compteur->id )}}"><i class='far fa-trash-alt' style='font-size:20px;color:red'></i></a>
                  </td>
                </tr>
                <?php $i++; ?>
              @endforeach
